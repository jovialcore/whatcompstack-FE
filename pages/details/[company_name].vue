<template>
	<div class="container-fluid">
		<div class="d-flex justify-content-start align-items-center gap-2 ms-md-5 mb-3 mb-md-5">
			...
			<span style="color: #17a1fa; cursor: pointer"
			...
			<div class="col-12 col-md-5 col-lg-3">
				<div class="card company-card">
					...
					<div class="company-card-body w-100">
						...
						<div class="d-inline">
							<span v-if="showLess" class="company-info"
								>{{ company.about.slice(0, 200) }}...</span
							>
							<span v-else class="company-info">{{ company.about }}</span>
							<span
								@click="toggleShowLess"
								style="color: #17a1fa; cursor: pointer"
							>
			...
			<div class="col-12 col-md-5 col-lg-7">
				<div class="row flex-column flex-lg-row mt-4 mt-md-0 info-card px-3">
					...
					<DetailsTechnologyInfoCard
						...
						:classObject="{
							'd-none': company.is_mobile_only || stack_fe?.length === 0,
						}"
					/>
